export const ErrorCodes = {
  ...
  LOTE_PRODUCTO_NO_PERMITIDO: 'LOTE_PRODUCTO_NO_PERMITIDO',
  ...
  SIEMBRA_SIN_BANDEJAS_EN_COOLING: 'SIEMBRA_SIN_BANDEJAS_EN_COOLING',
  BANDEJA_NOT_FOUND: 'BANDEJA_NOT_FOUND',
  LOTE_TIPO_INCORRECTO: 'LOTE_TIPO_INCORRECTO',
  LOTE_ESTABLECIMIENTO_MISMATCH: 'LOTE_ESTABLECIMIENTO_MISMATCH',
  ...
  MESA_NOMBRE_DUPLICADO: 'MESA_NOMBRE_DUPLICADO',
  ...
  PRODUCTO_NOMBRE_DUPLICADO: 'PRODUCTO_NOMBRE_DUPLICADO',
  PRODUCTO_FIELD_IMMUTABLE: 'PRODUCTO_FIELD_IMMUTABLE',
  PRODUCTO_REFERENCED: 'PRODUCTO_REFERENCED',
  VARIEDAD_NOT_FOUND: 'VARIEDAD_NOT_FOUND',
  VARIEDAD_NOMBRE_DUPLICADO: 'VARIEDAD_NOMBRE_DUPLICADO',
  VARIEDAD_FIELD_IMMUTABLE: 'VARIEDAD_FIELD_IMMUTABLE',
  VARIEDAD_REFERENCED: 'VARIEDAD_REFERENCED',
  VARIEDAD_PRODUCTO_MISMATCH: 'VARIEDAD_PRODUCTO_MISMATCH',

  // marcas
  MARCA_NOT_FOUND: 'MARCA_NOT_FOUND',
  MARCA_NOMBRE_DUPLICADO: 'MARCA_NOMBRE_DUPLICADO',
  MARCA_FIELD_IMMUTABLE: 'MARCA_FIELD_IMMUTABLE',
  MARCA_REFERENCED: 'MARCA_REFERENCED',
} as const;
